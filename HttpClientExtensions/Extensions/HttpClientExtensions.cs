...
using MRBHub.Web.HttpClientExtensions;
using MRBHub.Web.HttpClientExtensions.Constants;
using MRBHub.Web.HttpClientExtensions.Serialization;
...
namespace System.Net.Http
{
    public static class HttpClientExtensions
    {
        ...
        public static async Task<HttpResponseMessage> GetAsync(this HttpClient httpClient, string url, CancellationToken cancellationToken,
        ...
        public static async Task<HttpResponseMessage> PostAsync<T>(this HttpClient httpClient, string url, T body, CancellationToken cancellationToken,
        ...
        public static async Task<HttpResponseMessage> PatchAsync<T>(this HttpClient httpClient, string url, T body, CancellationToken cancellationToken,
            QueryString queryString = null, IDictionary<string, string> headers = null) where T : class
        {
        ...
        public static async Task<HttpResponseMessage> PutAsync<T>(this HttpClient httpClient, string url, T body, CancellationToken cancellationToken,
            QueryString queryString = null, IDictionary<string, string> headers = null) where T : class
        {
